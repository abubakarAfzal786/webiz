...
const reviewsMass = [], officeMass = [];

let reviewsSlider, officeSlider;
...
$(document).ready(function () {
    ...
    $('.office-slider .swiper-container').each(function (index, element) {
        let $this = $(this);
        officeSlider = new Swiper($this, {
            slidesPerView: 1,
            spaceBetween: 0,
            grabCursor: true,
            loop: true,
            ...
            navigation: {
                nextEl: $this.closest('.office-slider').find('.next-slide')[0],
                prevEl: $this.closest('.office-slider').find('.prev-slide')[0],
                disabledClass: 'disabled'
            },
            breakpoints: {
